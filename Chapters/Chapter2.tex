...
The Network Simulator (ns-2) is a network simulator 
...
\begin{itemize}
    ...
    \item Answered some of the first and second research question
    \item In the next chapter the first will continue being answered
\end{itemize}

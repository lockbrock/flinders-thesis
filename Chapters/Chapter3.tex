...
In this chapter we have answered the first research question: "\firstRQ".
...
This chapter provided a thorough analysis of the Serval DNA test framework.
...
\end{itemize}
The analysis of the limitations of the test framework and the development of this list of improvements has answered the third research question: "\thirdRQ".
In the next chapter, these improvements will begin to be implemented.
This will begin to answer the first half of the final research question: "\fourthRQ". 

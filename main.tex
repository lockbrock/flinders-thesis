...
\thesistitle{Developing Automatic Network Testing for an Ad-hoc Hetrogenous Mesh Network} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{Bachelour of Engineering(Software)(Honours)} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\subject{Software Engineergin} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
